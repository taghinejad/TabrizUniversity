...
\renewcommand{\algorithmicfor}{\if@RTL\textbf{حلقه }\else\textbf{for}\fi}
...
\renewcommand{\algorithmicendfor}{\algorithmicend\textbf{   }\algorithmicfor}
\renewcommand{\algorithmicendwhile}{\algorithmicend\textbf{   }\algorithmicwhile}
\renewcommand{\algorithmicendloop}{\algorithmicend\textbf{   }\algorithmicloop}
